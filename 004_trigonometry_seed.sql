...
INSERT INTO exercise_rubrics (exercise_id, criterion_id, label, points, description) VALUES
  ('drill_trb_fr_03', 'R1', '三平方の定理でCAを求める',       2, 'CA² = 13 - 4 = 9 → CA = 3 の計算が正しい'),
  ('drill_trb_fr_03', 'R2', 'sinA, cosA, tanAの立式',          2, '対辺/斜辺, 隣辺/斜辺, 対辺/隣辺の各立式が正しい'),
  ('drill_trb_fr_03', 'R3', '分母の有理化',                    1, '√13を含む分数を有理化している（有理化なしでも部分点）');
...
INSERT INTO exercise_rubrics (exercise_id, criterion_id, label, points, description) VALUES
  ('drill_tri_tf_03', 'R1', 'sin²θの変換',                 2, 'sin²θ = 1 - cos²θ または (1-cosθ)(1+cosθ) への変換が正しい'),
  ('drill_tri_tf_03', 'R2', '約分',                         2, '(1+cosθ) で約分する処理が正しい'),
  ('drill_tri_tf_03', 'R3', '最終値',                       1, '3/4 が正しい');
...
INSERT INTO exercise_rubrics (exercise_id, criterion_id, label, points, description) VALUES
  ('drill_tcr_fs_03', 'R1', '余弦定理の立式',           2, 'a² = b² + c² - 2bc·cosA の立式が正しい'),
  ('drill_tcr_fs_03', 'R2', 'cos150°の値と計算',         2, 'cos150° = -√3/2 を正しく代入し計算'),
  ('drill_tcr_fs_03', 'R3', '最終値',                    1, 'a = 2√13 が正しい');
...
INSERT INTO exercise_rubrics (exercise_id, criterion_id, label, points, description) VALUES
  ('drill_tar_wsr_02', 'R1', '角Aの計算',               1, 'A = 180° - 45° - 60° = 75° が正しい'),
  ('drill_tar_wsr_02', 'R2', '正弦定理で辺を求める',     2, '正弦定理の立式と計算が正しい'),
  ('drill_tar_wsr_02', 'R3', '面積公式の適用',           1, 'S = (1/2)bc sinA の立式が正しい'),
  ('drill_tar_wsr_02', 'R4', '最終値',                   1, '最終値が正しい');
...
INSERT INTO exercise_rubrics (exercise_id, criterion_id, label, points, description) VALUES
  ('drill_tar_her_03', 'R1', '半周長sの計算',     1, 's = 12 が正しい'),
  ('drill_tar_her_03', 'R2', '各因子の計算',       2, 's-a=5, s-b=4, s-c=3 が正しい'),
  ('drill_tar_her_03', 'R3', '公式適用と簡約化',   2, '√720 = 12√5 まで正しく計算');
